module XClarityClient
  ...
  module Mixins::UpdateCompMixin
    ...
    def apply_firmware_update(opts, activation_mode = nil,
      ...
      UpdateCompManagement.new(@config).apply_firmware_update(
        opts,
        activation_mode,
        force_update_mode,
        onerror_mode
    ...
    def cancel_firmware_update(server = nil, switch = nil, storage = nil,
                               cmm = nil)
      UpdateCompManagement.new(@config).cancel_firmware_update(
        server,
        switch,
        storage,
        cmm
    ...
    def modify_power_state(server = nil, switch = nil, storage = nil, cmm = nil)
      UpdateCompManagement.new(@config).modify_power_state(
        server,
        switch,
        storage,
        cmm
